...
var kHeadersSymbol = Symbol('headers');
...
function patch(Response) {
    ...
    if (!Response.prototype.hasOwnProperty('_setHeader')) {
        Response.prototype._setHeader = Response.prototype.setHeader;
    }

    /**
     * Pass through to native response.setHeader()
     *
     * @private
     * @memberof Response
     * @instance
     * @param {String} key - header key
     * @param {Object} value - header key
     * @function setHeader
     * @fires    header
     * @returns  {undefined} no return value
     */
    Response.prototype.setHeader = function restifySetHeader(key, value) {
        if (!this[kHeadersSymbol]) {
            this[kHeadersSymbol] = {};
        }
        this[kHeadersSymbol][key] = value;
    };
...
function flush(res, body) {
    ...
    // Flush headers
    res.writeHead(res.statusCode, res[kHeadersSymbol]);
